...
public class TokenGenerator {
     ...
     * @param salt the salt to be usedAccessTokenProcessingFilterAccessTokenProcessingFilterAccessTokenProcessingFilterAccessTokenProcessingFilterAccessTokenProcessingFilterAccessTokenProcessingFilter for encryption
     *
    ...
    public TokenGenerator(String password, String salt) throws IllegalArgumentException {
        ...
        Assert.notNull(salt, "salt canAccessTokenProcessingFilternot be null");
